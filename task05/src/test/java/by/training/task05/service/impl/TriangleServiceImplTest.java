...
public class TriangleServiceImplTest {
    ...
    public void testReadWrong(int id) {
        service.read(id);
    }
    ...
    public void testCreateFromFile(String filename) {
    ...
    public void testGetByAreaFindSpecification(String filename, int expectedQuantity, int minArea, int maxArea) {
        service.createFromFile(filename);
    ...
    public void testGetByFirstOctantSpecification(String filename, int expectedQuantity) {
        service.createFromFile(filename);
    ...
    public void testSortByXYZSpecification(String inputFilename, String expectedFilename) {
