...
public class CreateIntegerArrayFromFile implements Command {

    private static final Logger logger = LogManager.getLogger(CreateIntegerArrayFromFile.class);
    ...
    public String execute(String request) throws CommandException {
        ...
        try {
            index = arrayService.createIntegerFromFile(request);
