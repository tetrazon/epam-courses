...
public class CreateDoubleArray implements Command {
    private static final Logger logger = LogManager.getLogger(CreateDoubleArray.class);
    ...
    public String execute(String request) throws CommandException {
        int index = -1;
        try {
            index = arrayService.createDouble(request);
